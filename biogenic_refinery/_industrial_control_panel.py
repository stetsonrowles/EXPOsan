...
#data_path = '/Users/lewisrowles/Dropbox/My Mac (Lewiss-MBP.lan1)/Documents/UIUC/Gates/QSDsan/QSD_adding_biogenic_refinery/_industrial_control_panel.csv' 
data_path = os.path.abspath(os.path.dirname('_industrial_control_panel.csv'))
# data_path += 'sanunit_data/_industrial_control_panel.csv'
