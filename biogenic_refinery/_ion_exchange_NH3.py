...
#data_path = '/Users/lewisrowles/Dropbox/My Mac (Lewiss-MBP.lan1)/Documents/UIUC/Gates/QSDsan/QSD_adding_biogenic_refinery/_ion_exchange_NH3.csv' 
...
# in _run: define influent and effluent streams and treatment processes 
    def _run(self):
        ...
        self.volume_treated = waste.F_vol
    ...
    def _design(self):
        ...
        self.quantity_columns = np.ceil(self.volume_treated * self.column_daily_loading_rate 
                                   * 10e3) # number of 0.4 m columns
        design['PVC'] = PVC_quant = (self.column_length * self.quantity_columns 
                                     * self.pvc.mass) # kg PVC
        Tubing_quant = (self.tubing_length * self.quantity_columns 
                                           * self.tubing_mass) # kg PE
        Tank_quant = (self.quantity_columns * self.tank_mass) # PE
    ...
    def _cost(self):
        ...
        self.purchase_costs['Tubing'] = (self.cost_tubing * self.tubing_length 
                                         * self.quantity_columns)
        self.purchase_costs['Tank'] = (self.quantity_columns * self.tank_cost)
