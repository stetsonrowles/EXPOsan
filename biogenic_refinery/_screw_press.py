...
#data_path = '/Users/lewisrowles/Dropbox/My Mac (Lewiss-MBP.lan1)/Documents/UIUC/Gates/QSDsan/QSD_adding_biogenic_refinery/_screw_press.csv' 
data_path = os.path.abspath(os.path.dirname('_screw_press.csv'))

# data_path += 'sanunit_data/_screw_press.csv'
...
class ScrewPress(SludgeSeparator):
    ...
    def __init__(self, ID='', ins=None, outs=(), split=None, 
                 settled_frac=None, **kwargs):
...
# load data from csv each name will be self.name    
        ...
        self.settled_frac = self.dewatering_solids_capture
...
# in _run: define influent and effluent streams and treatment processes 
    ...
    def _cost(self):
        ...
        OM_costs = (((self.polymer_demand * self.polymer_cost) + dewatered_water_treatment_cost)) # $/hr
