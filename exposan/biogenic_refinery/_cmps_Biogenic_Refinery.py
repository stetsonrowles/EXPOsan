...
Resin = Component('Resin', MW=1, phase='s', particle_size='Particulate',
                    degradability='Undegradable', organic=False,
                    description='Cationic resin for N recovery')
# 1200 kg/m3 
# 
...
cmps = Components((NH3, NonNH3, C, P, K, Mg, Ca, H2O, OtherSS, N2O, CH4, O2, N2,
                   CO2, P4O10, Tissue, WoodAsh, Struvite, HAP, Polymer, Resin,
